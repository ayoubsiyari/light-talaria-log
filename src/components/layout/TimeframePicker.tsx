    ...
    <div className="flex items-center gap-0.5 min-w-0">
          ...
          return (
            <button
              ...
              className={[
                ...
                '[@media(hover:none)]:min-h-10 [@media(hover:none)]:min-w-10',
                active
      ...
      <Popover>
        ...
        <Popover.Trigger
          ...
          className="shrink-0 h-7 w-6 rounded inline-flex items-center justify-center text-muted hover:text-foreground hover:bg-background/60 text-[10px]"
        >
          ▾
        </Popover.Trigger>
